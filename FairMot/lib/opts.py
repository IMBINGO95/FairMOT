...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--load_model', default='/datanew/hwb/data/Tracking/FairMOT/pretrained_models/all_dla34.pth',
                             help='path to pretrained model')
    ...
    self.parser.add_argument('--input_video', type=str, default='/datanew/hwb/data/足球视频/test.MP4', help='path to the input video')
    self.parser.add_argument('--output_format', type=str, default='video', help='video or text')
    self.parser.add_argument('--output_root', type=str, default='../results', help='expected output root path')

    # mot
    self.parser.add_argument('--data_cfg', type=str,
                             default='../FairMot/lib/cfg/data.json',
    ...
    self.parser.add_argument('-dn', '--dir_name', default='11', help='the name of the dir(game)')
