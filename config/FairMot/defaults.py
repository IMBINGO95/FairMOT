...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--load_model', default='/datanew/hwb/FairMOT-master/FairMot/lib/models/all_dla34.pth',
                             help='path to pretrained model')
    ...
    self.parser.add_argument('--input_video', type=str, default='/datanew/hwb/data/Football/SoftWare/8/ch08_20190804165959_MergeFile_20200113201242.mp4', help='path to the input video')
